    ...
    <body>
        ...
        <div id="show-familia" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.familia}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.familia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
