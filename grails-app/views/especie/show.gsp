    ...
    <body>
        ...
        <div id="show-especie" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.especie}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.especie}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
