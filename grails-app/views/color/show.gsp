    ...
    <body>
        ...
        <div id="show-color" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.color}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.color}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
