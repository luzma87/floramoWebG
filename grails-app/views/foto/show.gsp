...
<html>
    ...
    <body>
        ...
        <div id="show-foto" class="content scaffold-show" role="main">
            ...
            <f:display bean="foto" />
            <g:form resource="${this.foto}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.foto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
