    ...
    <body>
        ...
        <div id="show-genero" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.genero}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.genero}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
