    ...
    <body>
        ...
        <div id="show-lugar" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.lugar}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.lugar}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
