...
<html>
    ...
    <body>
        ...
        <div id="show-formaVida" class="content scaffold-show" role="main">
            ...
            <f:display bean="formaVida" />
            <g:form resource="${this.formaVida}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="${this.formaVida}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
