    ...
    <body>
        ...
        <div id="show-${propertyName}" class="content scaffold-show" role="main">
            ...
            <g:form resource="\${this.${propertyName}}" method="DELETE">
                <g:link class="edit waves-effect waves-light btn blue lighten-1" action="edit" resource="\${this.${propertyName}}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
